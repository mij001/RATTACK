...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : IND_LED_1_Pin IND_LED_2_Pin */
  GPIO_InitStruct.Pin = IND_LED_1_Pin|IND_LED_2_Pin;
  ...
  /*Configure GPIO pins : IR_5_LED_Pin IR_6_LED_Pin CTRL_BTN_Pin */
  GPIO_InitStruct.Pin = IR_5_LED_Pin|IR_6_LED_Pin|CTRL_BTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : MPU_6050_INT_Pin */
  ...
  /*Configure GPIO pins : MPU_6050_TOF_SCL_Pin MPU_6050_TOF_SDA_Pin */
  GPIO_InitStruct.Pin = MPU_6050_TOF_SCL_Pin|MPU_6050_TOF_SDA_Pin;
